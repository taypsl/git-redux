// example of simplest possible reducer: if the state is empty, then set to its intial value (in this case, an empty array)
...
// in this example, the actions actually change the state: 
